...
feature 'user creates new cleanup', %Q{
  ...
  scenario 'creates new cleanup' do
    ...
    fill_in 'Description', with: 'Did this as a solo beach cleanup. Not too much litter on this stretch. Most common items were fishing line and glass bottles.'
    click_button 'Submit'
  ...
  scenario 'fail to specify cleanup metadata' do
    ...
    click_button 'Submit'
    expect(page).to have_content('Please provide the following information about your cleanup before submitting: title, posted by, date, state, city, cleanup type, volunteers, total trash')
